package com.bachelorshelter.nasir.medicaladviser.activities;
...
import com.bachelorshelter.nasir.medicaladviser.R;
import com.bachelorshelter.nasir.medicaladviser.adapter.SearchResultAdapter;
import com.bachelorshelter.nasir.medicaladviser.app.AppConfig;
import com.bachelorshelter.nasir.medicaladviser.app.AppController;
import com.bachelorshelter.nasir.medicaladviser.model.SearchResultItem;
...
public class SearchResultActivity extends AppCompatActivity implements SearchResultAdapter.SearchResultItemClickCallback,SearchView.OnQueryTextListener {
    ...
    private void fetchSearch(final String sort){
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, AppConfig.GET_SEARCH_RESULT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i <jsonArray.length() ; i++) {
                        ...
                        searchResultItem.setDelivery_time(object.getString("delivary_in"));
